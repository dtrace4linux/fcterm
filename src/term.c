...
usage()
{
	...
	fprintf(stderr, "	-dump     	Dump screens to /tmp\n");
	fprintf(stderr, "	-e cmd ...	Command to execute (last on line)\n");
	fprintf(stderr, "	-f		Do not fork from shell.\n");
	fprintf(stderr, "	-isc		Emulate Interactive Unix console driver.\n");
	fprintf(stderr, "	-ls		Execute a login shell.\n");
	fprintf(stderr, "	-[no]group      Group fcterms together to maintain position.\n");
	fprintf(stderr, "	-sco		Emulate SCO Unix console driver.\n");
	fprintf(stderr, "	-spill  	Enable infinite log spilling\n");
	fprintf(stderr, "	+/-sf		+sf => disable sun function keys\n");
	fprintf(stderr, "			-sf => enable Sun Function keys.\n");
	...
	fprintf(stderr, " -xrm *saveLines:NNN             Number of lines to keep in memory\n");
	fprintf(stderr, " -xrm *spillSize:NNN[mkg]        Set default spill size.\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "Environment variables:\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_ENABLE_PRIMARY       default:%d\n", enable_primary);
	fprintf(stderr, "CTW_ENABLE_SECONDARY     default:%d\n", enable_secondary);
	fprintf(stderr, "CTW_ENABLE_CLIPBOARD     default:%d\n", enable_clipboard);
	fprintf(stderr, "CTW_ENABLE_CUT_BUFFER0   default:%d\n", enable_cut_buffer0);
	fprintf(stderr, "    Set default clipboard mode.\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_DO_CONT\n");
	fprintf(stderr, "    Show end-of-line autowrap continuations.\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_DRAW_WATCH\n");
	fprintf(stderr, "    Enable visual drawing actions (for debugging).\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_FILL_TO_BLACK\n");
	fprintf(stderr, "    Enable fill-to-black ISO standard.\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_FREETYPE\n");
	fprintf(stderr, "    Enable freetype font drawing.\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_GZIP_ROLLOVER\n");
	fprintf(stderr, "    Enable compression of the scrolling spill files (in /tmp).\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_HISTORY\n");
	fprintf(stderr, "    Enable history (infinite) scrolling.\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_LOGDIR\n");
	fprintf(stderr, "    Directory where fcterm stores its state and screen logs.\n");
	fprintf(stderr, "\n");
	fprintf(stderr, "CTW_WORD_CHARS\n");
	fprintf(stderr, "    Specify the word-break characters for double-click selection.\n");
	fprintf(stderr, "\n");
