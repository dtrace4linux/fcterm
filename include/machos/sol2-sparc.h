...
# define	CPU_FLOAT_BYTE_ORDER	{7, 6, 5, 4, 3, 2, 1, 0}
# define	CPU_INT_ORDER	0x01020304
# define	CR_FLAGS	"CR_SOLARIS2_SPARC"
# define	CR_MACHINE_ID	"sol2-sparc"
# define	CR_PLATFORM_ID	33
...
# define	MMU_PAGESIZE_DEFAULT	8192
